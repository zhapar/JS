class UI {
  ...
  paint(weather) {
    ...
    this.string.textContent = (+weather.main.temp - 273.15).toFixed() + " °C";
    this.icon.setAttribute(
      "src",
      `https://openweathermap.org/themes/openweathermap/assets/vendor/owm/img/widgets/0${weather.weather[0].icon[1]}d.png`
    );
