...
const UICtrl = (function () {
  ...
  return {
    ...
    clearInput: function () {
      document.querySelector(UISelectors.nameInput).value = "123";
      document.querySelector(UISelectors.caloriesInput).value = "500";
    },
    addItemToForm: function () {
      document.querySelector(
        UISelectors.nameInput
      ).value = ItemCtrl.logData().currentState.name;
      document.querySelector(
        UISelectors.caloriesInput
      ).value = ItemCtrl.logData().currentState.name;
      console.log(ItemCtrl.logData().currentState.name);
      UICtrl.showEditForm();
    },
